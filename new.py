...
baseline = 0.110 # Physical distance between left and right cameras in meters (11 cm)
...
# ====================================================================
# Stereo Block Matching (BM) is used instead of SGBM for real-time speed.
# numDisparities: Max pixel shift expected. blockSize: Window size for matching.
...
# Step 1: Compute initial depth map (disparity)
old_disparity = stereo.compute(old_left, old_right)

# Step 2: Extract 2D features from the left camera
...
# winSize: Search area. maxLevel: Image pyramid depth for large motions.
...
for i in range(1, len(left_images)):
    ...
    # Step 4: Optical Flow. Where did the t=0 pixels move to in t=1?
